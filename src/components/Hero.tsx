...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-navy via-navy-light to-purple-dark/20">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 text-center lg:text-left animate-fade-in">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold">
              ...
              <span className="block text-gradient mt-2">Cientista de Dados</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button 
                size="lg" 
                className="bg-accent hover:bg-accent/90 text-accent-foreground shadow-lg hover:shadow-accent/50 transition-all duration-300"
              ...
              <Button 
                size="lg" 
                variant="outline"
                className="border-muted-foreground/30 hover:bg-muted/50 hover:border-accent transition-all duration-300"
              >
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
          <button 
            ...
            className="p-2 rounded-full bg-card/50 border border-border hover:border-accent transition-all duration-300"
          >
